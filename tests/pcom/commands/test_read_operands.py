...
class TestReadOperands(TestCase):
    ...
    def test_parse_MB_MF_MI_non_vector(self):
        ...
        reply_header = bytearray(
            b'\x2F\x5F\x4F\x50\x4C\x43\xFE\x00\x01\x01\x00\x00\xCD\x00\x00\x00\x00\x00\x03\x00\x0B\x00\x69\xFC')
        reply_details = bytearray(b'\x35\x7B\x00\x7C\x00\x7D\x00\x40\x46\xAE\xE6')
    ...
    def test_parse_MB_MI_non_vector(self):
        ...
        reply_header = bytearray(
            b'\x2F\x5F\x4F\x50\x4C\x43\xFE\x00\x01\x00\x00\x00\xCD\x00\x00\x00\x00\x00\x02\x00\x07\x00\x6F\xFC')
        reply_details = bytearray(b'\x75\xD2\x04\xD7\x11\x17\x31')
