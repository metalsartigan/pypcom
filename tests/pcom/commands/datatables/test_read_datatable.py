...
class TestReadDatatable(BaseTest):
    def setUp(self) -> None:
        super().setUp()
        self._command = datatables.ReadDatatable(structure=self._structure, start_row_index=3, row_count=10,
    ...
    def test_parse_reply(self):
        ...
        raw_reply = bytearray(b'/_OPLC\xfe\x00\x01\x00\x00\x00\x84d\x00\x00\x00\x00\x00\x00L\x00\x11\xfc\t\xca\x9a;\xcc\xa35w\xaa\xfb.\xb5\x01\x99\xbc\x00\x00\x02\x04\xf2 @h\x82A\xe4\x07b\x02\xe2\x04\x19\x16\xd0 \x80\x00\x00\t\xca\x9a;3\xa35ww!\x02\xb3\x00k;\x00\x00\x02\x04\xf2 @h\x82A\xe4\x07b\x02\xda\x04(\x16\xd0 \x80\x00\x00\x8d\xe6\\')
